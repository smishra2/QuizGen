            ...
            if(root.tag().equalsIgnoreCase("nn") || root.tag().equalsIgnoreCase("jj")) {
                ...
                while(relationIter.hasNext()) {
                    ...
                    if(relation.equalsIgnoreCase("nsubj")) {
                        ...
                        if(test) System.out.println("Inserting into predicateObject graph: " + edge.getTarget().toString());
                ...
                while(relationIter.hasNext()) {
                    ...
                    if(relation.equalsIgnoreCase("nn")) {
                        if(test) System.out.println("Inserting into subject graph: " + edge.getTarget().toString());
